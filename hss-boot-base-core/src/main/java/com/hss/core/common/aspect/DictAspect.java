...
import com.hss.core.common.aspect.annotation.Dict;
...
public class DictAspect {
     ...
     * 定义切点Pointcut
     */
    @Pointcut("execution(public * com.hss.core.modules..*.*Controller.*(..)) || @annotation(com.hss.core.common.aspect.annotation.AutoDict)")
