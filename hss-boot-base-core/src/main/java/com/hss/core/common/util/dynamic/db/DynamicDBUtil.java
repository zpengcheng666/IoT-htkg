package com.hss.core.common.util.dynamic.db;

import com.alibaba.druid.pool.DruidDataSource;
import com.hss.core.common.exception.HssBootException;
import com.hss.core.common.system.vo.DynamicDataSourceModel;
import com.hss.core.common.util.OConvertUtils;
import com.hss.core.common.util.ReflectHelper;
    ...
    public static DruidDataSource getDbSourceByDbKey(final String dbKey) {
        ...
        if (cacheDbSource != null && !cacheDbSource.isClosed()) {
            ...
            if(dataSource!=null && dataSource.isEnable()){
                ...
                throw new HssBootException("动态数据源连接失败，dbKey："+dbKey);
            }
