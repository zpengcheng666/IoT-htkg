...
@Slf4j
public class HssBootExceptionHandler {

	/**
	 * 处理自定义异常
	 */
	@ExceptionHandler(HssBootException.class)
	public Result<?> handleHssBootException(HssBootException e){
	...
	public Result<?> handleHssCloudException(JeecgCloudException e){
		log.error(e.getMessage(), e);
		return Result.error(e.getMessage());
	}
	 ...
	 * 处理自定义异常
	 */
	@ExceptionHandler(HssBoot401Exception.class)
	@ResponseStatus(HttpStatus.UNAUTHORIZED)
	public Result<?> handleHssBoot401Exception(HssBoot401Exception e){
		log.error(e.getMessage(), e);
