...
import com.hss.core.common.constant.enums.ModuleType;
import com.hss.core.common.constant.enums.OperateTypeEnum;
...
public class AutoLogAspect {
    ...
    @Pointcut("@annotation(com.hss.core.common.aspect.annotation.AutoLog)")
    ...
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        //保存日志
        saveSysLog(point, time, result,operate);

        return result;
    }

    private void saveSysLog(ProceedingJoinPoint joinPoint, long time, Object obj,String operate) {
        ...
        if(syslog != null){
            ...
            if (StringUtils.isNotBlank(content) && StringUtils.isNotBlank(operate)){
