...
import com.hss.core.common.util.CommonUtils;
import com.hss.core.common.util.DateUtils;
import com.hss.core.common.util.OConvertUtils;
import com.hss.core.common.util.SqlInjectionUtil;
...
public class QueryGenerator {
	...
	private static void doMultiFieldsOrder(QueryWrapper<?> queryWrapper,Map<String, String[]> parameterMap, Map<String,String> fieldColumnMap) {
		...
		if (OConvertUtils.isNotEmpty(column) && OConvertUtils.isNotEmpty(order)) {
			...
			if (!allColumnExist(column, allFields)) {
				throw new HssBootException("请注意，将要排序的列字段不存在：" + column);
			}
	...
	public static Map<String, SysPermissionDataRuleModel> getRuleMap() {
		...
		List<SysPermissionDataRuleModel> list = HssDataAutorUtils.loadDataSearchConditon();
