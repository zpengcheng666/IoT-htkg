package com.hss.modules.es7.service.impl;

import cn.hutool.core.collection.ListUtil;
import cn.hutool.core.util.StrUtil;
import com.hss.modules.es7.dao.EsProductDao;
import com.hss.modules.es7.domain.EsProduct;
import com.hss.modules.es7.domain.EsProductRelatedInfo;
import com.hss.modules.es7.repository.EsProductRepository;
import com.hss.modules.es7.service.EsProductService;
...
public class EsProductServiceImpl implements EsProductService {
    ...
    public Page<EsProduct> search(String keyword, Long brandId, Long productCategoryId, Integer pageNum, Integer pageSize,Integer sort) {
        ...
        LOGGER.info("DSL:{}", Objects.requireNonNull(searchQuery.getQuery()).toString());
